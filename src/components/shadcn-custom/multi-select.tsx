// Component source: https://github.com/sersavan/shadcn-multi-select-component/blob/43764c51364ca36022154a59827bfcedeeb7d5ab/src/components/multi-select.tsx
// Component copyright (per license, see below): Copyright (c) 2024 sersavan
// Component license: MIT License https://github.com/sersavan/shadcn-multi-select-component/blob/43764c51364ca36022154a59827bfcedeeb7d5ab/LICENSE
...
// Component customization for @natlibfi: Added translation hook
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    // @natlibfi customiaztion: added translate function
    // all {t('')} -definitions from here onwards are customizations to the original component
        ...
        >
            ...
            >
              {selectedValues.length > 0 ? (
                  ...
                  >
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        {`+ ${
                          selectedValues.length - responsiveSettings.maxCount
                        }`} {/* natlibfi customization: Removed phrase that is not currently translated to all three languages */}
                        <XCircle
                          className={cn(
                ...
                <div className="flex items-center justify-between w-full mx-auto">
                  <span className="text-sm text-muted-foreground mx-3 overflow-ellipsis overflow-hidden">
                    {placeholder}
                  </span>
          ...
          >
            <Command>
              {searchable && (
                <CommandInput
                  placeholder={t('components.multiselect.search')}
                  ...
                  <div className="flex items-center justify-between">
                    {selectedValues.length > 0 && (
                      <>
                        ...
                        >
                          {t('components.multiselect.clear')}
                        </CommandItem>
                        <Separator
                          orientation="vertical"
                          className="flex min-h-6 h-full"
                    ...
                    >
                      {t('components.multiselect.close')}
                    </CommandItem>
                  </div>
                </CommandGroup>
              </CommandList>
