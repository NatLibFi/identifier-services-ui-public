...
const sv = {
  ...
  'accessibilityStatement.title': 'Tillgänglighetsutlåtande',
  'accessibilityStatement.description.main': 'Detta tillgänglighetsutlåtande gäller tjänsten Identifikatorservice och har upprättats 9.5.2023 (uppdaterat 23.10.2023). Tjänsten omfattas av lagen om tillhandahållande av digitala tjänster, som förutsätter att offentliga webbtjänster ska vara tillgängliga. En förteckning över de tillgänglighetskrav som anges i utlåtandet finns i {link}.',
  'accessibilityStatement.description.main.link': 'Riktlinjer för tillgängligt webbinnehåll (WCAG) 2.1',
  'accessibilityStatement.description.secondary': 'Vi har själva granskat hur tillgänglig tjänsten är.',
  'accessibilityStatement.status.title': 'Tillgänglighetsstatus för den digitala tjänsten',
  'accessibilityStatement.status.description': 'Uppfyller delvis tillgänglighetskraven.',
  'accessibilityStatement.issues.title': 'Icke-tillgängligt innehåll',
  'accessibilityStatement.issues.disclaimer': 'Oproportionell börda',
  'accessibilityStatement.issues.disclaimer.description': 'Arbetet med att förnya tjänsten har ännu inte slutförts inom alla delområden, vilket gör att det kan förekomma brister i användbarheten. Om användaren inte kan hämta önskad information ur det nuvarande användargränssnittet eller skicka en ansökan som gäller identifikatorer, går det att skicka en begäran om information eller en ansökan till adressen isbn-keskus@helsinki.fi.',
  'accessibilityStatement.issues.subTitle1': 'Innehåll som inte är tillgängligt och dess brister',
  'accessibilityStatement.issues.subTitle2': 'Tillgänglighetskrav som inte uppfylls',
  'accessibilityStatement.issues.list.title': 'Webbplatsen uppfyller ännu inte kraven till alla delar',
  'accessibilityStatement.issues.labels.title': 'Möjlig att uppfatta: ikonernas ledtexter/etiketter är bristfälliga',
  'accessibilityStatement.issues.labels.description': 'Ledtexten/etiketten (label) för ikonen publikationstyp i förlagsregistrets listvy syns inte på en skärmläsare (aria-hidden). Ledtexterna/etiketterna (label) för social media-ikonerna i sidfoten är inte tillräckligt tydliga.',
  'accessibilityStatement.issues.labels.wcag': '1.1.1 Innehåll som inte är text',
  'accessibilityStatement.issues.semantics.title': 'Möjlig att uppfatta: elementens semantiska betydelse',
  'accessibilityStatement.issues.semantics.description': 'På ingångssidan används <br>-element som användaren av en skärmläsare hör i formen ”empty group”. Tabellkomponenten i förlagsregistrets listvy saknar en semantisk struktur (t.ex. caption).',
  'accessibilityStatement.issues.semantics.wcag': '1.3.1 Information och relationer',
  'accessibilityStatement.issues.reflow.title': 'Möjlig att uppfatta: dubbelriktad rullning',
  'accessibilityStatement.issues.reflow.description': 'Innehållet är inte helt responsivt när sidans bredd är under 450px (målet är 320px). Detta har inte nödvändigtvis någon direkt inverkan på funktionerna, men påverkar klart användbarheten och tjänstens tillgänglighet.',
  'accessibilityStatement.issues.reflow.wcag': '1.4.10 Responsivitet',
  'accessibilityStatement.issues.links.title': 'Hanterbar: textalternativen i språkmenyn är otydliga',
  'accessibilityStatement.issues.links.description': 'Textalternativen i språkmenyns länkar är inte tydliga, användaren av en skärmläsare hör dem som de är – EN, FI, SV.',
  'accessibilityStatement.issues.links.wcag': '2.4.4 Länkens syfte (i kontext)',
  'accessibilityStatement.issues.siteMap.title': 'Hanterbar: en sidkarta fattas',
  'accessibilityStatement.issues.siteMap.description': 'För närvarande finns det bara ett sätt att lokalisera en enskild sida: navigeringsmenyn.',
  'accessibilityStatement.issues.siteMap.wcag': '2.4.5 Flera sätt',
  'accessibilityStatement.issues.titles.title': 'Hanterbar: rubriknivåerna är i fel ordning',
  'accessibilityStatement.issues.titles.description': 'Vissa rubriknivåer på ansökningsblanketten för ISBN och ISMN och på förläggarens anslutningsblankett är i fel ordning. Det är fråga om rubrikerna för inforutorna på följande sidor: Tilläggsinformation (Förläggare), Basuppgifter, Seriens uppgifter, Publikationsform (ISBN/ISMN).',
  'accessibilityStatement.issues.titles.wcag': '2.4.6 Rubriker och ledtexter/etiketter',
  'accessibilityStatement.issues.footer.title': 'Hanterbar: social media-etiketterna i sidfoten i focus-läge',
  'accessibilityStatement.issues.footer.description': 'Indikatorerna för social media-etiketterna i sidfoten syns dåligt i focus-läge.',
  'accessibilityStatement.issues.footer.wcag': '2.4.7 Synligt fokus',
  'accessibilityStatement.issues.lang.title': 'Begripligt: Html lang-attributet uppdateras inte',
  'accessibilityStatement.issues.lang.description': 'Html lang-attributet uppdateras i vissa situationer inte enligt användargränssnittets språk.',
  'accessibilityStatement.issues.lang.wcag': '3.1.1 Sidans språk',
  'accessibilityStatement.issues.batch.title': 'Begripligt: Texten i infomeddelandet (popup) på sidan för listan över identifikatorer saknar lang-attribut.',
  'accessibilityStatement.issues.batch.description': 'Infomeddelandet på sidan för en enskild lista över identifikatorer innehåller texter på tre olika språk. Var och en av dem bör vara separat märkt med sitt eget lang-attribut.',
  'accessibilityStatement.issues.batch.wcag': '3.1.2 Språk för del av sida',
  'accessibilityStatement.issues.required.title': 'Begripligt: Html required-attributen saknas',
  'accessibilityStatement.issues.required.description': 'Obligatoriska fält kan anges genom att använda html required-attribut. Blanketterna ska också innehålla en förklaring, såsom * för obligatoriska fält.',
  'accessibilityStatement.issues.required.wcag': '3.3.2 Ledtexter/etiketter eller instruktioner',
  'accessibilityStatement.feedback.title': 'Har du upptäckt bristande tillgänglighet i vår digitala tjänst?',
  'accessibilityStatement.feedback.description': 'Berätta för oss så gör vi vårt bästa för att åtgärda bristen.',
  'accessibilityStatement.feedback.contact.title': 'Via e-post',
  'accessibilityStatement.feedback.contact.email': 'isbn-keskus@helsinki.fi',
  'accessibilityStatement.authority.title': 'Tillsynsmyndighet',
  'accessibilityStatement.authority.description': 'Om du upptäcker tillgänglighetsproblem på webbplatsen, ge respons till oss som är webbansvariga. Det kan dröja 14 dagar innan du får ett svar. Om du inte är nöjd med det svar du har fått eller inte får något svar alls inom två veckor kan du lämna in en tillgänglighetsklagan till {link}. På Traficoms webbplats beskrivs i detalj hur du kan lämna in en anmälan och hur ärendet behandlas.',
  'accessibilityStatement.authority.description.link': 'Traficoms enhet för övervakning',
  'accessibilityStatement.authority.contact.title': 'Tillsynsmyndighetens kontaktuppgifter',
  'accessibilityStatement.authority.contact.organization': 'Transport- och kommunikationsverket Traficom',
  'accessibilityStatement.authority.contact.department': 'Enheten för tillsyn över digital tillgänglighet',
  ...
  'accessibilityStatement.authority.contact.phone': 'telefon (telefonväxeln) 029 534 5000',
