...
const sv = {
  ...
  'common.publications': 'Publikationer',
  ...
  'error.identifierBatch.invalid': 'Laddningen av identifikatorerna misslyckades. Vänligen försök på nytt eller ta kontakt med vår kundservice isbn-keskus@helsinki.fi',
  ...
  'errorPage.message.serviceDown': 'Webbplatsen är ur bruk. Vänligen försök igen senare. Om problemen fortsätter, vänligen ta kontakt med vår kundservice isbn-keskus@helsinki.fi',
  'errorPage.message.serviceUnderMaintenance': ' Serviceavbrott på webbplatsen. Vänligen försök igen senare. Om problemen fortsätter, vänligen ta kontakt med vår kundservice isbn-keskus@helsinki.fi',
  'errorPage.message.defaultError': 'Ett okänt fel uppstod. Vänligen försök på nytt eller ta kontakt med vår kundservice isbn-keskus@helsinki.fi ',
  'errorPage.message.generatingMessageFailed': 'Skapandet av meddelande misslyckades. Vänligen försök på nytt eller ta kontakt med vår kundservice isbn-keskus@helsinki.fi',
  ...
  'errorPage.publicationRequestError': 'Denna webbplats kan inte nås. Vänligen kontrollera webbadressen och försök igen. Om problemen fortsätter, vänligen ta kontakt med vår kundservice isbn-keskus@helsinki.fi',
  ...
  'form.common.additionalDetails': 'Övrig information',
  ...
  'form.isbnIsmn.preview.printFormatOther': 'Övriga utgåvor',
  ...
  'form.isbnIsmn.preview.edition': 'Upplaga',
  ...
  'form.isbnIsmn.preview.isPublic': 'Allmän',
  ...
  'form.isbnIsmn.card.otherUniversity': 'Vänligen kontrollera med din enhet/fakultet om du får ett ISBN från ditt universitet, innan du fyller i detta ISBN formulär. Ta kontakt med vår kundtjänst vid behov: isbn-keskus@helsinki.fi',
